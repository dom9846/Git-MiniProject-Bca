...
<?php
   ...
   $query1="select * from employtable where place='Muvattupuzha' and branch='Automobile'";
   $query2="select * from employtable where place='Vazhakulam' and branch='Automobile'";
   $query3="select * from employtable where place='Thodupuzha' and branch='Automobile'";
   $query4="select * from employtable where place='Kothamangalam' and branch='Automobile'";
    ...
    <section id="portfolio" class="portfolio">
      <div class="container" data-aos="fade-up">
        <div class="section-header">
          <h3 class="section-title">Employees In Automobile Field</h3>
