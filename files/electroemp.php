...
<?php
   ...
   $query1="select * from employtable where place='Muvattupuzha' and branch='Electronics'";
   $query2="select * from employtable where place='Vazhakulam' and branch='Electronics'";
   $query3="select * from employtable where place='Thodupuzha' and branch='Electronics'";
   $query4="select * from employtable where place='Kothamangalam' and branch='Electronics'";
    ...
    <section id="portfolio" class="portfolio">
      <div class="container" data-aos="fade-up">
        <div class="section-header">
          <h3 class="section-title">Employees In Electronics Field</h3>
