...
<?php
   ...
   $query1="select * from employtable where place='Muvattupuzha' and branch='Construction'";
   $query2="select * from employtable where place='Vazhakulam' and branch='Construction'";
   $query3="select * from employtable where place='Thodupuzha' and branch='Construction'";
   $query4="select * from employtable where place='Kothamangalam' and branch='Construction'";
    ...
    <section id="portfolio" class="portfolio">
      <div class="container" data-aos="fade-up">
        <div class="section-header">
          <h3 class="section-title">Employees In Construction Field</h3>
